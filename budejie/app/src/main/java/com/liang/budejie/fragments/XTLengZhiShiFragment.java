package com.liang.budejie.fragments;
...
import com.liang.budejie.R;
import com.liang.budejie.adapter.ComprehensiveAdapter;
import com.liang.budejie.bean.JHTuiJianBean;
import com.liang.budejie.config.Config;
import com.liang.budejie.until.HttpUntil;
import com.liang.budejie.until.JsonUntil;
import com.liang.budejie.until.ThreadUtil;
 ...
 */
public class XTLengZhiShiFragment extends Fragment {

    @Bind(R.id.ptrlComprehensive)
    PullToRefreshListView ptrlComprehensive;
    View view;
    ...
    public void getDataFromNet(final int what, final int count) {
        ThreadUtil.execute(new Runnable() {
            ...
            public void run() {
                try {
                    String json = HttpUntil.getXTLengZhiShiJson(count,getContext());
